...
% columns last, meaning that the matrix will be closer to a right stochastic
% matrix than a left one. Minor alterations were also made to keep the
% matrix sparse, with the goal of speedup.

function [A, r, c] = sinkhornKnoppRow(A, varargin)
